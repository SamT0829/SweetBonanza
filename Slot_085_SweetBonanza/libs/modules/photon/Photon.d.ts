...
declare module Photon.LoadBalancing {
    ...
    class Room extends RoomInfo {
        ...
        */
        setUniqueUserId(unique: boolean): void;
        /**
    ...
    class LoadBalancingClient {
        ...
        */
        setCustomAuthentication(authParameters: string, authType?: number, authData?: string): void;
        /**
        ...
        **/
        webRpc(uriPath: string, parameters?: {}): void;
        /**
...
declare module Photon.Chat {
    ...
    */
    ...
    class ChatClient extends Photon.LoadBalancing.LoadBalancingClient {
        ...
        */
        subscribe(channelNames: string[], messagesFromHistory?: number): boolean;
        /**
