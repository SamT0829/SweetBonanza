...
type HowlErrorCallback = (soundId: number, error: any) => void;

interface SoundSpriteDefinitions {
    [name: string]: [number, number] | [number, number, boolean];
}

interface HowlListeners {
    /**
...
interface HowlOptions extends HowlListeners {
    /**
...
declare let Howler: Howler;
declare let Howl: Howl;

declare module "howler" {
    export let Howler: Howler;
